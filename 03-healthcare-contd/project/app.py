...
You have access to a SQLite patient database at data/patients.db.
        ...
        if isinstance(msg, StreamEvent):
            ...
            if event.get("type") == "content_block_delta":
                ...
                if delta.get("type") == "text_delta":
                    await response_msg.stream_token(delta.get("text", ""))
...
async def on_chat_end():
    ...
    if client:
        try:
            ...
            # Chainlit's disconnect fires in a different task context than the SDK client
            # was created in, causing anyio cancel scope errors. Safe to ignore since
            # the subprocess will be cleaned up when the session ends.
            pass
