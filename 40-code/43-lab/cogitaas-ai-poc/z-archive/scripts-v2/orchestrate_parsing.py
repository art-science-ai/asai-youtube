...
DEFAULT_SOURCE_DIR = Path("/home/nikhilmaddirala/repos/monorepo/cogitaas-ai-poc/onedrive-data")
DEFAULT_OUTPUT_DIR = Path("/home/nikhilmaddirala/repos/monorepo/cogitaas-ai-poc/parsed_data")
DEFAULT_FILE_TYPES = None  # Parse all supported file types
