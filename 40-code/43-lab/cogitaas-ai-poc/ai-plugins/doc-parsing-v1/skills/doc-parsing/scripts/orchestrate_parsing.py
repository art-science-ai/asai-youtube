...
def should_parse_file(source_file: Path, output_dir: Path, force: bool) -> bool:
    ...
    try:
        ...
        previous_hash = summary.get("file_hash")
...
def main():
    ...
    for file_type, files in files_by_type.items():
        ...
        for source_file in files:
            ...
            # Read the parsing_summary.json created by the parser and augment it with orchestration metadata
            summary_file = file_output_dir / "parsing_summary.json"
            file_output_dir.mkdir(parents=True, exist_ok=True)

            # Load existing summary from parser (if it exists)
            existing_summary = {}
            ...
            # Merge with orchestration metadata
            summary_data = {
                **existing_summary,
                "file_hash": file_hash,
