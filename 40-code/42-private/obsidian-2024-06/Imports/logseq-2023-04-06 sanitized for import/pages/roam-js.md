...
- CSS for custom tags {{[[roam/js]]}}
	 - 
```javascript
var myVar = "Important"
var styles = `
  span.rm-page-ref[data-tag=${myVar}],
  [data-link-title="Important"] {
...
span.rm-page-ref-link-color[data-link-title=${myVar}] {
    color: rgb(255,0,0) !important;
}
`
