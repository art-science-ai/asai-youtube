...

{
  ...
  # Note: Default browser MIME types are set in modules/home/browsing/browsers/default.nix
  # This keeps browser configuration centralized and works across all desktop environments
  ...
  dconf.settings = {
     ...
     "org/gnome/shell/default-browser" = {
       exec = "zen-twilight";
     };
     ...
     "org/gnome/shell/extensions/paperwm/keybindings" = {
       ...
       move-left = ["<Super><Ctrl>h" "<Super><Ctrl>Left"];
       move-right = ["<Super><Ctrl>l" "<Super><Ctrl>Right"];
       move-up = ["<Super><Ctrl>k" "<Super><Ctrl>Up"];
       move-down = ["<Super><Ctrl>j" "<Super><Ctrl>Down"];
       switch-monitor-left = ["<Super><Shift>h" "<Super><Shift>Left"];
       switch-monitor-right = ["<Super><Shift>l" "<Super><Shift>Right"];
       switch-monitor-up = ["<Super><Shift>k" "<Super><Shift>Up"];
       switch-monitor-down = ["<Super><Shift>j" "<Super><Shift>Down"];
       move-window-monitor-left = ["<Super><Shift><Ctrl>h" "<Super><Shift><Ctrl>Left"];
       move-window-monitor-right = ["<Super><Shift><Ctrl>l" "<Super><Shift><Ctrl>Right"];
       move-window-monitor-up = ["<Super><Shift><Ctrl>k" "<Super><Shift><Ctrl>Up"];
       move-window-monitor-down = ["<Super><Shift><Ctrl>j" "<Super><Shift><Ctrl>Down"];
